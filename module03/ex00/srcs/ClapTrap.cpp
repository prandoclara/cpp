...
/*   Updated: 2025/01/24 14:27:16 by clara            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(){
    ...
    std::cout << GREY << this->_name << " constructor!" << RESET << std::endl;
    return;
}
...
ClapTrap::~ClapTrap(){
    std::cout << GREY << this->_name << " destroyed!" << RESET << std::endl;
    return ;
}
...
ClapTrap::ClapTrap(const ClapTrap & src)
{
	...
	std::cout << "new " << this->_name << " copied from " << src._name << "!" << std::endl;
